...
To build the final jar and optimize the reviewproHandlerApplication application for production, run:
...
Then navigate to [http://localhost:1010](http://localhost:1010) in your browser.
