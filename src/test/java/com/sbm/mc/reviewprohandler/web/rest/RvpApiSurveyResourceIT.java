...
class RvpApiSurveyResourceIT {
    ...
    private static final Boolean DEFAULT_ACTIBE = false;
    private static final Boolean UPDATED_ACTIBE = true;
    ...
    void getAllRvpApiSurveys() throws Exception {
        ...
        restRvpApiSurveyMockMvc
            ...
            .andExpect(jsonPath("$.[*].actibe").value(hasItem(DEFAULT_ACTIBE.booleanValue())))
    ...
    void getRvpApiSurvey() throws Exception {
        ...
        restRvpApiSurveyMockMvc
            ...
            .andExpect(jsonPath("$.actibe").value(DEFAULT_ACTIBE.booleanValue()))
