package com.sbm.mc.reviewprohandler.serdes;
...
public class JacksonSerializerConfig extends AbstractConfig {
    ...
    static final String USE_ANNOTATIONS_DOC =
        "See [USE_ANNOTATIONS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#USE_ANNOTATIONS)";
    static final String USE_GETTERS_AS_SETTERS_DOC =
        "See [USE_GETTERS_AS_SETTERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#USE_GETTERS_AS_SETTERS)";
    static final String PROPAGATE_TRANSIENT_MARKER_DOC =
        "See [PROPAGATE_TRANSIENT_MARKER](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#PROPAGATE_TRANSIENT_MARKER)";
    static final String AUTO_DETECT_CREATORS_DOC =
        "See [AUTO_DETECT_CREATORS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#AUTO_DETECT_CREATORS)";
    static final String AUTO_DETECT_FIELDS_DOC =
        "See [AUTO_DETECT_FIELDS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#AUTO_DETECT_FIELDS)";
    static final String AUTO_DETECT_GETTERS_DOC =
        "See [AUTO_DETECT_GETTERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#AUTO_DETECT_GETTERS)";
    static final String AUTO_DETECT_IS_GETTERS_DOC =
        "See [AUTO_DETECT_IS_GETTERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#AUTO_DETECT_IS_GETTERS)";
    static final String AUTO_DETECT_SETTERS_DOC =
        "See [AUTO_DETECT_SETTERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#AUTO_DETECT_SETTERS)";
    static final String REQUIRE_SETTERS_FOR_GETTERS_DOC =
        "See [REQUIRE_SETTERS_FOR_GETTERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#REQUIRE_SETTERS_FOR_GETTERS)";
    static final String ALLOW_FINAL_FIELDS_AS_MUTATORS_DOC =
        "See [ALLOW_FINAL_FIELDS_AS_MUTATORS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#ALLOW_FINAL_FIELDS_AS_MUTATORS)";
    static final String INFER_PROPERTY_MUTATORS_DOC =
        "See [INFER_PROPERTY_MUTATORS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#INFER_PROPERTY_MUTATORS)";
    static final String INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES_DOC =
        "See [INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES)";
    static final String CAN_OVERRIDE_ACCESS_MODIFIERS_DOC =
        "See [CAN_OVERRIDE_ACCESS_MODIFIERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#CAN_OVERRIDE_ACCESS_MODIFIERS)";
    static final String OVERRIDE_PUBLIC_ACCESS_MODIFIERS_DOC =
        "See [OVERRIDE_PUBLIC_ACCESS_MODIFIERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#OVERRIDE_PUBLIC_ACCESS_MODIFIERS)";
    static final String USE_STATIC_TYPING_DOC =
        "See [USE_STATIC_TYPING](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#USE_STATIC_TYPING)";
    static final String DEFAULT_VIEW_INCLUSION_DOC =
        "See [DEFAULT_VIEW_INCLUSION](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#DEFAULT_VIEW_INCLUSION)";
    static final String SORT_PROPERTIES_ALPHABETICALLY_DOC =
        "See [SORT_PROPERTIES_ALPHABETICALLY](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#SORT_PROPERTIES_ALPHABETICALLY)";
    static final String ACCEPT_CASE_INSENSITIVE_PROPERTIES_DOC =
        "See [ACCEPT_CASE_INSENSITIVE_PROPERTIES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#ACCEPT_CASE_INSENSITIVE_PROPERTIES)";
    static final String ACCEPT_CASE_INSENSITIVE_ENUMS_DOC =
        "See [ACCEPT_CASE_INSENSITIVE_ENUMS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#ACCEPT_CASE_INSENSITIVE_ENUMS)";
    static final String USE_WRAPPER_NAME_AS_PROPERTY_NAME_DOC =
        "See [USE_WRAPPER_NAME_AS_PROPERTY_NAME](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#USE_WRAPPER_NAME_AS_PROPERTY_NAME)";
    static final String USE_STD_BEAN_NAMING_DOC =
        "See [USE_STD_BEAN_NAMING](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#USE_STD_BEAN_NAMING)";
    static final String ALLOW_EXPLICIT_PROPERTY_RENAMING_DOC =
        "See [ALLOW_EXPLICIT_PROPERTY_RENAMING](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#ALLOW_EXPLICIT_PROPERTY_RENAMING)";
    static final String ALLOW_COERCION_OF_SCALARS_DOC =
        "See [ALLOW_COERCION_OF_SCALARS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#ALLOW_COERCION_OF_SCALARS)";
    static final String IGNORE_DUPLICATE_MODULE_REGISTRATIONS_DOC =
        "See [IGNORE_DUPLICATE_MODULE_REGISTRATIONS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#IGNORE_DUPLICATE_MODULE_REGISTRATIONS)";
    static final String IGNORE_MERGE_FOR_UNMERGEABLE_DOC =
        "See [IGNORE_MERGE_FOR_UNMERGEABLE](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/MapperFeature.html#IGNORE_MERGE_FOR_UNMERGEABLE)";
    static final String WRAP_ROOT_VALUE_DOC =
        "See [WRAP_ROOT_VALUE](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRAP_ROOT_VALUE)";
    static final String INDENT_OUTPUT_DOC =
        "See [INDENT_OUTPUT](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#INDENT_OUTPUT)";
    static final String FAIL_ON_EMPTY_BEANS_DOC =
        "See [FAIL_ON_EMPTY_BEANS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#FAIL_ON_EMPTY_BEANS)";
    static final String FAIL_ON_SELF_REFERENCES_DOC =
        "See [FAIL_ON_SELF_REFERENCES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#FAIL_ON_SELF_REFERENCES)";
    static final String WRAP_EXCEPTIONS_DOC =
        "See [WRAP_EXCEPTIONS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRAP_EXCEPTIONS)";
    static final String FAIL_ON_UNWRAPPED_TYPE_IDENTIFIERS_DOC =
        "See [FAIL_ON_UNWRAPPED_TYPE_IDENTIFIERS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#FAIL_ON_UNWRAPPED_TYPE_IDENTIFIERS)";
    static final String WRITE_DATES_AS_TIMESTAMPS_DOC =
        "See [WRITE_DATES_AS_TIMESTAMPS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_DATES_AS_TIMESTAMPS)";
    static final String WRITE_DATE_KEYS_AS_TIMESTAMPS_DOC =
        "See [WRITE_DATE_KEYS_AS_TIMESTAMPS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_DATE_KEYS_AS_TIMESTAMPS)";
    static final String WRITE_DATES_WITH_ZONE_ID_DOC =
        "See [WRITE_DATES_WITH_ZONE_ID](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_DATES_WITH_ZONE_ID)";
    static final String WRITE_DURATIONS_AS_TIMESTAMPS_DOC =
        "See [WRITE_DURATIONS_AS_TIMESTAMPS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_DURATIONS_AS_TIMESTAMPS)";
    static final String WRITE_CHAR_ARRAYS_AS_JSON_ARRAYS_DOC =
        "See [WRITE_CHAR_ARRAYS_AS_JSON_ARRAYS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_CHAR_ARRAYS_AS_JSON_ARRAYS)";
    static final String WRITE_ENUMS_USING_TO_STRING_DOC =
        "See [WRITE_ENUMS_USING_TO_STRING](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_ENUMS_USING_TO_STRING)";
    static final String WRITE_ENUMS_USING_INDEX_DOC =
        "See [WRITE_ENUMS_USING_INDEX](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_ENUMS_USING_INDEX)";
    static final String WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED_DOC =
        "See [WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED)";
    static final String WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS_DOC =
        "See [WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS)";
    static final String ORDER_MAP_ENTRIES_BY_KEYS_DOC =
        "See [ORDER_MAP_ENTRIES_BY_KEYS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#ORDER_MAP_ENTRIES_BY_KEYS)";
    static final String USE_EQUALITY_FOR_OBJECT_ID_DOC =
        "See [USE_EQUALITY_FOR_OBJECT_ID](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/SerializationFeature.html#USE_EQUALITY_FOR_OBJECT_ID)";
    ...
    static {
        ...
        configFeatureToConfig.put(
            MapperFeature.INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES,
            INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES_CONFIG
        );
        configToConfigFeature.put(
            INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES_CONFIG,
            MapperFeature.INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES
        );
    ...
    public static ConfigDef config() {
        ...
        config.define(
            USE_ANNOTATIONS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.USE_ANNOTATIONS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_ANNOTATIONS_DOC
        );
        config.define(
            USE_GETTERS_AS_SETTERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.USE_GETTERS_AS_SETTERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_GETTERS_AS_SETTERS_DOC
        );
        config.define(
            PROPAGATE_TRANSIENT_MARKER_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.PROPAGATE_TRANSIENT_MARKER.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            PROPAGATE_TRANSIENT_MARKER_DOC
        );
        config.define(
            AUTO_DETECT_CREATORS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.AUTO_DETECT_CREATORS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            AUTO_DETECT_CREATORS_DOC
        );
        config.define(
            AUTO_DETECT_FIELDS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.AUTO_DETECT_FIELDS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            AUTO_DETECT_FIELDS_DOC
        );
        config.define(
            AUTO_DETECT_GETTERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.AUTO_DETECT_GETTERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            AUTO_DETECT_GETTERS_DOC
        );
        config.define(
            AUTO_DETECT_IS_GETTERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.AUTO_DETECT_IS_GETTERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            AUTO_DETECT_IS_GETTERS_DOC
        );
        config.define(
            AUTO_DETECT_SETTERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.AUTO_DETECT_SETTERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            AUTO_DETECT_SETTERS_DOC
        );
        config.define(
            REQUIRE_SETTERS_FOR_GETTERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.REQUIRE_SETTERS_FOR_GETTERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            REQUIRE_SETTERS_FOR_GETTERS_DOC
        );
        config.define(
            ALLOW_FINAL_FIELDS_AS_MUTATORS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.ALLOW_FINAL_FIELDS_AS_MUTATORS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ALLOW_FINAL_FIELDS_AS_MUTATORS_DOC
        );
        config.define(
            INFER_PROPERTY_MUTATORS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.INFER_PROPERTY_MUTATORS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            INFER_PROPERTY_MUTATORS_DOC
        );
        config.define(
            INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            INFER_CREATOR_FROM_CONSTRUCTOR_PROPERTIES_DOC
        );
        config.define(
            CAN_OVERRIDE_ACCESS_MODIFIERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.CAN_OVERRIDE_ACCESS_MODIFIERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            CAN_OVERRIDE_ACCESS_MODIFIERS_DOC
        );
        config.define(
            OVERRIDE_PUBLIC_ACCESS_MODIFIERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.OVERRIDE_PUBLIC_ACCESS_MODIFIERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            OVERRIDE_PUBLIC_ACCESS_MODIFIERS_DOC
        );
        config.define(
            USE_STATIC_TYPING_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.USE_STATIC_TYPING.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_STATIC_TYPING_DOC
        );
        config.define(
            DEFAULT_VIEW_INCLUSION_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.DEFAULT_VIEW_INCLUSION.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            DEFAULT_VIEW_INCLUSION_DOC
        );
        config.define(
            SORT_PROPERTIES_ALPHABETICALLY_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.SORT_PROPERTIES_ALPHABETICALLY.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            SORT_PROPERTIES_ALPHABETICALLY_DOC
        );
        config.define(
            ACCEPT_CASE_INSENSITIVE_PROPERTIES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.ACCEPT_CASE_INSENSITIVE_PROPERTIES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ACCEPT_CASE_INSENSITIVE_PROPERTIES_DOC
        );
        config.define(
            ACCEPT_CASE_INSENSITIVE_ENUMS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.ACCEPT_CASE_INSENSITIVE_ENUMS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ACCEPT_CASE_INSENSITIVE_ENUMS_DOC
        );
        config.define(
            USE_WRAPPER_NAME_AS_PROPERTY_NAME_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.USE_WRAPPER_NAME_AS_PROPERTY_NAME.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_WRAPPER_NAME_AS_PROPERTY_NAME_DOC
        );
        config.define(
            USE_STD_BEAN_NAMING_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.USE_STD_BEAN_NAMING.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_STD_BEAN_NAMING_DOC
        );
        config.define(
            ALLOW_EXPLICIT_PROPERTY_RENAMING_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.ALLOW_EXPLICIT_PROPERTY_RENAMING.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ALLOW_EXPLICIT_PROPERTY_RENAMING_DOC
        );
        config.define(
            ALLOW_COERCION_OF_SCALARS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.ALLOW_COERCION_OF_SCALARS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ALLOW_COERCION_OF_SCALARS_DOC
        );
        config.define(
            IGNORE_DUPLICATE_MODULE_REGISTRATIONS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.IGNORE_DUPLICATE_MODULE_REGISTRATIONS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            IGNORE_DUPLICATE_MODULE_REGISTRATIONS_DOC
        );
        config.define(
            IGNORE_MERGE_FOR_UNMERGEABLE_CONFIG,
            ConfigDef.Type.BOOLEAN,
            MapperFeature.IGNORE_MERGE_FOR_UNMERGEABLE.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            IGNORE_MERGE_FOR_UNMERGEABLE_DOC
        );
        config.define(
            WRAP_ROOT_VALUE_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRAP_ROOT_VALUE.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRAP_ROOT_VALUE_DOC
        );
        config.define(
            INDENT_OUTPUT_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.INDENT_OUTPUT.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            INDENT_OUTPUT_DOC
        );
        config.define(
            FAIL_ON_EMPTY_BEANS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.FAIL_ON_EMPTY_BEANS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_EMPTY_BEANS_DOC
        );
        config.define(
            FAIL_ON_SELF_REFERENCES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.FAIL_ON_SELF_REFERENCES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_SELF_REFERENCES_DOC
        );
        config.define(
            WRAP_EXCEPTIONS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRAP_EXCEPTIONS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRAP_EXCEPTIONS_DOC
        );
        config.define(
            FAIL_ON_UNWRAPPED_TYPE_IDENTIFIERS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.FAIL_ON_UNWRAPPED_TYPE_IDENTIFIERS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_UNWRAPPED_TYPE_IDENTIFIERS_DOC
        );
        config.define(
            WRITE_DATES_AS_TIMESTAMPS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_DATES_AS_TIMESTAMPS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_DATES_AS_TIMESTAMPS_DOC
        );
        config.define(
            WRITE_DATE_KEYS_AS_TIMESTAMPS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_DATE_KEYS_AS_TIMESTAMPS_DOC
        );
        config.define(
            WRITE_DATES_WITH_ZONE_ID_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_DATES_WITH_ZONE_ID.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_DATES_WITH_ZONE_ID_DOC
        );
        config.define(
            WRITE_DURATIONS_AS_TIMESTAMPS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_DURATIONS_AS_TIMESTAMPS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_DURATIONS_AS_TIMESTAMPS_DOC
        );
        config.define(
            WRITE_CHAR_ARRAYS_AS_JSON_ARRAYS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_CHAR_ARRAYS_AS_JSON_ARRAYS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_CHAR_ARRAYS_AS_JSON_ARRAYS_DOC
        );
        config.define(
            WRITE_ENUMS_USING_TO_STRING_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_ENUMS_USING_TO_STRING.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_ENUMS_USING_TO_STRING_DOC
        );
        config.define(
            WRITE_ENUMS_USING_INDEX_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_ENUMS_USING_INDEX.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_ENUMS_USING_INDEX_DOC
        );
        config.define(
            WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED_DOC
        );
        config.define(
            WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRITE_DATE_TIMESTAMPS_AS_NANOSECONDS_DOC
        );
        config.define(
            ORDER_MAP_ENTRIES_BY_KEYS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.ORDER_MAP_ENTRIES_BY_KEYS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ORDER_MAP_ENTRIES_BY_KEYS_DOC
        );
        config.define(
            USE_EQUALITY_FOR_OBJECT_ID_CONFIG,
            ConfigDef.Type.BOOLEAN,
            SerializationFeature.USE_EQUALITY_FOR_OBJECT_ID.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_EQUALITY_FOR_OBJECT_ID_DOC
        );
        return config;
    }
