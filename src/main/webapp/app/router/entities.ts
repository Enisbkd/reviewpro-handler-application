...
const Rvpapilodging = () => import('@/entities/rvpapilodging/rvpapilodging.vue');
const RvpapilodgingUpdate = () => import('@/entities/rvpapilodging/rvpapilodging-update.vue');
const RvpapilodgingDetails = () => import('@/entities/rvpapilodging/rvpapilodging-details.vue');
...
export default {
  ...
  children: [
    ...
    {
      path: 'rvpapilodging/new',
      name: 'RvpapilodgingCreate',
      component: RvpapilodgingUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'rvpapilodging/:rvpapilodgingId/edit',
      name: 'RvpapilodgingEdit',
      component: RvpapilodgingUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'rvpapilodging/:rvpapilodgingId/view',
