      ...
      this.userManagementService
        ...
        .then(res => {
          this.alertService.showInfo(
            this.t$(res.headers['x-reviewprohandlerapplicationapp-alert'].toString(), {
              param: decodeURIComponent(res.headers['x-reviewprohandlerapplicationapp-params'].replace(/\+/g, ' ')),
            }),
            { variant: 'danger' },
          );
          this.removeId = null;
